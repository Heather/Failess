...
let failessExe = "packages/Failess/tools/Failess.exe"

downloadNugetTo nugetExe

if doesNotExist failessExe then 
    exec nugetExe ["install"; "Failess"; "-OutputDirectory packages"; "-ExcludeVersion"; "-Prerelease"]
exec failessExe ("makefile.fsx"::passedArgs)"
